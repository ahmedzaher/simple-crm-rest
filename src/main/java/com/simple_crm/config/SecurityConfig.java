...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 .antMatchers(HttpMethod.GET , "/customers/*", "/customers").hasRole("EMPLOYEE") 
		 .antMatchers(HttpMethod.POST , "/customers").hasAnyRole("ADMIN","MANAGER") 
		 .antMatchers(HttpMethod.PUT , "/customers").hasAnyRole("ADMIN","MANAGER") 
